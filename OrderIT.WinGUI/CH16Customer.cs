...
namespace OrderIT.WinGUI {
	public partial class CH16Customer : Form {
		public CH16Customer() {
			InitializeComponent();
		}
/*
...
*/
		private void btnRetrieveById_Click(object sender, EventArgs e)
		{
			...
			{
				var customer = proxy.ReadCustomer(Convert.ToInt32(CustomerId.Text));
		...
		private void btnDelete_Click(object sender, EventArgs e)
		{
			using (CustomerServiceClient proxy = new CustomerServiceClient())
			{
				...
				proxy.DeleteCustomer(id, version);
